...
<div class="container-fluid bg-alba-crema py-5">
    ...
    <div class="row my-5 py-5 justify-content-center bg-white shadow-sm section-quote">
        <div class="col-md-8 text-center py-4">
            <h3 class="display-about-title quote-text" style="font-size: 2.2rem;">
    ...
    <div class="container my-5 py-5">
        <div class="row align-items-center g-5 flex-md-row-reverse">
            <div class="col-md-6">
                <img src="{{ asset('img/Nosotros.png') }}" class="img-fluid img-sobre-nosotros shadow-sm" alt="Equipo ALBA">
            </div>
            <div class="col-md-6">
