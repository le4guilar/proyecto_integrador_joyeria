...
<div class="container mt-5">
    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/arete1.png') }}" class="img-fluid mb-3" alt="Arete">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/arete2.png') }}" class="img-fluid mb-3" alt="Arete">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/arete3.png') }}" class="img-fluid mb-3" alt="Arete">
...
<div class="container mt-5">
    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/Pulsera1.png') }}" class="img-fluid mb-3" alt="Pulsera">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/Pulsera2.png') }}" class="img-fluid mb-3" alt="Pulsera">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/Pulsera3.png') }}" class="img-fluid mb-3" alt="Pulsera">
...
<div class="container mt-5">
    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/collar1.png') }}" class="img-fluid mb-3" alt="Collar">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/collar2.png') }}" class="img-fluid mb-3" alt="Collar">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina1/collar3.png') }}" class="img-fluid mb-3" alt="Collar">
