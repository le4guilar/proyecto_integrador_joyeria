...
<div class="container mt-5">
    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pulsera1.png') }}" class="img-fluid mb-3" alt="Anillo">
                <h5 class="nombre-joya">Anillo Cruzado Brillante de Oro Blanco</h5>
                <p class="precio-joya">$ 51.634,94</p>
                <a href="#" class="btn-ver-mas">Ver Detalles</a>
            </div>
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pulsera2.png') }}" class="img-fluid mb-3" alt="Anillo">
                <h5 class="nombre-joya">Anillo Ondas Lumière</h5>
                <p class="precio-joya">$ 51.634,94</p>
                <a href="#" class="btn-ver-mas">Ver Detalles</a>
            </div>
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pulsera3.png') }}" class="img-fluid mb-3" alt="Anillo">
                <h5 class="nombre-joya">Anillo Multibanda Élite</h5>
                <p class="precio-joya">$ 51.634,94</p>
                <a href="#" class="btn-ver-mas">Ver Detalles</a>
            </div>
