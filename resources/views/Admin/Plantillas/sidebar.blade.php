<div class="bg-dark text-white p-3 vh-100 sticky-top" style="width: 250px;">
    <h4 class="text-center border-bottom pb-2">Panel Admin</h4>
    <ul class="nav flex-column mt-3">
        <li class="nav-item">
            <a href="admin#" class="nav-link text-white"><i class="bi bi-speedometer2 me-2"></i>Inicio</a>
        </li>
        <li class="nav-item">
            <a href="categoria-joyas" class="nav-link text-white"><i class="bi bi-collection me-2"></i>Categorías</a>
        </li>
        <li class="nav-item">
