    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/anillo4.png') }}" class="img-fluid mb-3" alt="Anillo">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/anillo5.png') }}" class="img-fluid mb-3" alt="Anillo">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/anillo6.png') }}" class="img-fluid mb-3" alt="Anillo">
...
<div class="container mt-5">
    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/arete4.png') }}" class="img-fluid mb-3" alt="Arete">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/arete5.png') }}" class="img-fluid mb-3" alt="Arete">
...
<div class="container mt-5">
    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/pulsera4.png') }}" class="img-fluid mb-3" alt="Pulsera">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/pulsera6.png') }}" class="img-fluid mb-3" alt="Pulsera">
...
<div class="container mt-5">
    ...
    <div class="row g-5">
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/collar4.png') }}" class="img-fluid mb-3" alt="Collar">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/collar5.png') }}" class="img-fluid mb-3" alt="Collar">
        ...
        <div class="col-md-4 text-center">
            <div class="producto-card">
                <img src="{{ asset('img/Catalogo/Pagina2/collar6.png') }}" class="img-fluid mb-3" alt="Collar">
